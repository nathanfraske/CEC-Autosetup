...
- [`docs/stress-harness.md`](docs/stress-harness.md) — QC stress harness: phase-1 orchestrator (`tools/Invoke-StressTest.ps1`) with QPC markers, WHEA gating, device-ID'd reports; the researched buy/build plan, 1kHz-correlation marker design, licensing table, phasing.
